...
| 5 | `apps/core/db/schema.rb` contains 7 tables that have no matching `create_table` migration files (`ai_*`, `lti_*`, `data_retention_policies`), which can cause migration-path inconsistencies across environments. | Platform | Open | 2026-02-14 |
