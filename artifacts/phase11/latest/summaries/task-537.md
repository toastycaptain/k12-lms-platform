# Task 537: Myp Subject Teacher Criteria And Atl Workflow

- Group: myp_teacher
- Status: complete
- Output discipline: artifacts land under `artifacts/phase11/runs/<runId>/...`
- Source task file: `spec/ib-phase11-codex-tasks/537_MYP_SUBJECT_TEACHER_CRITERIA_AND_ATL_WORKFLOW.md`
