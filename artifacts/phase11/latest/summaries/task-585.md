# Task 585: Middle Years Student Unit And Project Journey

- Group: student
- Status: complete
- Output discipline: artifacts land under `artifacts/phase11/runs/<runId>/...`
- Source task file: `spec/ib-phase11-codex-tasks/585_MIDDLE_YEARS_STUDENT_UNIT_AND_PROJECT_JOURNEY.md`
