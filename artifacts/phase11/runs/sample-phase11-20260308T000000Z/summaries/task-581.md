# Task 581: Ib Director Governance Exceptions And Recovery

- Group: ib_director
- Status: complete
- Output discipline: artifacts land under `artifacts/phase11/runs/<runId>/...`
- Source task file: `spec/ib-phase11-codex-tasks/581_IB_DIRECTOR_GOVERNANCE_EXCEPTIONS_AND_RECOVERY.md`
