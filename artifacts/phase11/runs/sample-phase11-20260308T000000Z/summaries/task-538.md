# Task 538: Myp Subject Teacher Assessment And Feedback Loop

- Group: myp_teacher
- Status: complete
- Output discipline: artifacts land under `artifacts/phase11/runs/<runId>/...`
- Source task file: `spec/ib-phase11-codex-tasks/538_MYP_SUBJECT_TEACHER_ASSESSMENT_AND_FEEDBACK_LOOP.md`
