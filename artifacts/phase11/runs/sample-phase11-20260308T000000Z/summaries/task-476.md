# Task 476: Simulation Environment Profiles Local Ci Staging

- Group: foundations
- Status: complete
- Output discipline: artifacts land under `artifacts/phase11/runs/<runId>/...`
- Source task file: `spec/ib-phase11-codex-tasks/476_SIMULATION_ENVIRONMENT_PROFILES_LOCAL_CI_STAGING.md`
