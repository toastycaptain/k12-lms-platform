...
function LoginContent() {
  ...
  function submitAuthPost(targetUrl: string): void {
  ...
  function startSsoSignIn(): void {
    ...
    setLocalError(null);
    persistAuthRedirect(redirectParam);
    submitAuthPost(buildAuthUrlWithRedirect(getSamlAuthUrl(slug), redirectParam));
  }
    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50">
      <div className="w-full max-w-sm rounded-lg bg-white p-8 shadow-md">
        ...
        <div className="space-y-3">
          {authMethods.google && (
            <form method="post" action={googleAuthHref} onSubmit={startGoogleSignIn}>
              <button
                type="submit"
